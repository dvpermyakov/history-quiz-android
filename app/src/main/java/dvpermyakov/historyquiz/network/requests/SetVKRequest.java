...
/**
 * Created by dvpermyakov on 27.10.2016.
 */
public class SetVKRequest extends BaseRequest<SuccessResponse> {

    public SetVKRequest(Response.Listener<SuccessResponse> listener, Response.ErrorListener errorListener, Map<String, String> getParams) {
        super(Urls.SET_VK_REQUEST_URL, listener, errorListener, getParams);
    }
