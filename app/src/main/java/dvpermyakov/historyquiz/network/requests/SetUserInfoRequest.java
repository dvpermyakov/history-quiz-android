...
public class SetUserInfoRequest extends BaseRequest<SuccessResponse> {

    public SetUserInfoRequest(Response.Listener<SuccessResponse> listener, Response.ErrorListener errorListener, Map<String, String> getParams) {
        super(Urls.SET_USER_INFO_REQUEST_URL, listener, errorListener, getParams);
    }
